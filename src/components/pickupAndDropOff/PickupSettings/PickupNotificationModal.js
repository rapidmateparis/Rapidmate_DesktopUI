...
function PickupNotificationModal({ show, handleClose }) {
  ...
  return (
    ...
    <div>
      <Modal className="pickupNotification-modalMain" show={show} onHide={handleClose} centered>
        ...
        <Modal.Footer>
          <div>
            <Link to="/pickup-notifications" className="pickupNotification-SeeallBtn">See all</Link>
          </div>
        </Modal.Footer>
      </Modal>
      </div>
...
export default PickupNotificationModal;
