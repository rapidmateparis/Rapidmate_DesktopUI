...
import PickupNotificationModal from "../PickupSettings/PickupNotificationModal";
    ...
    <div className="pickupHeader">
      <nav className="nav">
        ...
        <div className="nav-header">
          <Link to="/pickup-home" className="homeHeader-Logocard">
        ...
        <ul className="nav-list">
          <li>
            <Link to="/pickup-home">Request delivery</Link>
          </li>
          <li>
            <Link to="/pickup-history">Past orders</Link>
          </li>
          <li>
            <Link>Messages</Link>
          </li>
          <div className="login-nav-list">
            ...
            <li>
              <Dropdown>
                ...
                <Dropdown.Menu>
                  <Dropdown.Item>
                  <Link className="pickupHeader-accountTextsActions" to="/pickup-account"><FontAwesomeIcon className="pickupHeader-accounts-Icons" icon={faUser} /> Account</Link>
                  </Dropdown.Item>
