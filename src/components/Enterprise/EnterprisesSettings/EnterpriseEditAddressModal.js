...
function EnterpriseEditAddressModal({ show, handleClose }) {
      ...
      <Modal show={show} onHide={handleClose} centered>
        <Modal.Header>
          <div className="modalPickup-EditAddress-header">
            <p className="vehicleDimensions-TextHead">Edit address</p>
            <FontAwesomeIcon
        ...
        <Modal.Footer>
          <div>
              <button className="pickupEdit-addressDeleteBtn">Delete</button>
...
export default EnterpriseEditAddressModal;
